...
HD_PWD='C:/Users/pr3de/Documents/MASA/ECE475Project/ECE475Project.runs/TopLevel_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevel_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopLevel_lmb_bram_0.tcl
